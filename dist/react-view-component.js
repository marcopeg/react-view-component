	...
	var View = exports.View = (_temp2 = _class = function (_React$Component) {
	    ...
	    function View() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(View)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
	            ...
	            animationClass: _this.props.isVisible ? 'visible' : 'offscreen'
	        }, _this.onWindowResize = function () {
	            _this.setState(_extends({}, (0, _viewport.getSize)()));
	        }, _this.setAnimationClass = function (val) {
	    ...
	    _createClass(View, [{
	        ...
	        value: function willShow() {
	            ...
	            setTimeout(function () {
	                _this2.setAnimationClass('entering');
	                setTimeout(function () {
	                    _this2.setAnimationClass('afterEnter');
	                    setTimeout(function () {
	                        return _this2.setAnimationClass('visible');
	                    });
	                }, 300);
	            });
	        }
	        ...
	        value: function willHide() {
	            ...
	            setTimeout(function () {
	                _this3.setAnimationClass('leaving');
	                setTimeout(function () {
	                    _this3.setAnimationClass('afterLeave');
	                    setTimeout(function () {
	                        return _this3.setAnimationClass('offscreen');
	                    });
	                }, 300);
	            });
	        }
	        ...
	        value: function render() {
	            ...
	            var props = _objectWithoutProperties(_props, ['mode', 'width', 'height', 'margin', 'border', 'borderTop', 'borderRight', 'borderBottom', 'borderLeft', 'borderRadius', 'color', 'contentColor', 'shadow', 'direction', 'flex', 'align', 'center', 'viewport', 'horizontal', 'isVisible', 'scroll', 'float', 'children', 'childrenWidth', 'childrenHeight', 'childrenColor', 'style', 'contentStyle', 'enterAnimation', 'leaveAnimation']);
	    ...
	    enterAnimation: _react2.default.PropTypes.oneOf(['none', 'fade', 'slideDown', 'slideUp', 'slideRight', 'slideLeft', 'explode', 'implode']),
	    leaveAnimation: _react2.default.PropTypes.oneOf(['none', 'fade', 'slideDown', 'slideUp', 'slideRight', 'slideLeft', 'explode', 'implode'])
	}, _class.defaultProps = {
	    color: null,
	    contentColor: null,
	    shadow: null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".none__offscreen,\n.none__beforeLeave,\n.none__leaving,\n.none__afterLeave {\n  display: none; }\n\n.none__visible,\n.none__beforeEnter,\n.none__entering,\n.none__afterEnter {\n  display: block; }\n\n.fade {\n  transition: opacity 0.3s ease-in-out; }\n\n.fade__offscreen {\n  display: none; }\n\n.fade__beforeEnter {\n  display: block;\n  opacity: 0; }\n\n.fade__entering {\n  opacity: 1; }\n\n.fade__visible {\n  display: block;\n  opacity: 1; }\n\n.fade__leaving {\n  opacity: 0; }\n\n.slideDown__offscreen {\n  display: none; }\n\n.slideDown__beforeEnter {\n  display: block;\n  transform: translate3d(0, -100%, 0);\n  transition: transform 0.3s ease-in-out; }\n\n.slideDown__entering {\n  display: block;\n  transition: transform 0.3s ease-in-out;\n  transform: translate3d(0, 0, 0); }\n\n.slideDown__visible {\n  display: block;\n  transform: translate3d(0, 0, 0); }\n\n.slideDown__beforeLeave {\n  display: block;\n  transform: translate3d(0, 0, 0);\n  transition: transform 0.3s ease-in-out; }\n\n.slideDown__leaving {\n  display: block;\n  transition: transform 0.3s ease-in-out;\n  transform: translate3d(0, 100%, 0); }\n\n.slideDown__afterLeave {\n  display: none; }\n\n.slideUp__offscreen {\n  display: none; }\n\n.slideUp__beforeEnter {\n  display: block;\n  transform: translate3d(0, 100%, 0);\n  transition: transform 0.3s ease-in-out; }\n\n.slideUp__entering {\n  display: block;\n  transform: translate3d(0, 0, 0);\n  transition: transform 0.3s ease-in-out; }\n\n.slideUp__visible {\n  display: block;\n  transform: translate3d(0, 0, 0); }\n\n.slideUp__beforeLeave {\n  display: block;\n  transform: translate3d(0, 0, 0);\n  transition: transform 0.3s ease-in-out; }\n\n.slideUp__leaving {\n  display: block;\n  transform: translate3d(0, -100%, 0);\n  transition: transform 0.3s ease-in-out; }\n\n.slideUp__afterLeave {\n  display: none; }\n\n.slideLeft__offscreen {\n  display: none; }\n\n.slideLeft__beforeEnter {\n  display: block;\n  transform: translate3d(100%, 0, 0);\n  transition: transform 0.3s ease-in-out; }\n\n.slideLeft__entering {\n  display: block;\n  transform: translate3d(0, 0, 0);\n  transition: transform 0.3s ease-in-out; }\n\n.slideLeft__visible {\n  display: block;\n  transform: translate3d(0); }\n\n.slideLeft__beforeLeave {\n  display: block;\n  transform: translate3d(0, 0, 0);\n  transition: transform 0.3s ease-in-out; }\n\n.slideLeft__leaving {\n  display: block;\n  transform: translate3d(-100%, 0, 0);\n  transition: transform 0.3s ease-in-out; }\n\n.slideLeft__afterLeave {\n  display: none; }\n\n.slideRight__offscreen {\n  display: none; }\n\n.slideRight__beforeEnter {\n  display: block;\n  transform: translate3d(-100%, 0, 0);\n  transition: transform 0.3s ease-in-out; }\n\n.slideRight__entering {\n  display: block;\n  transform: translate3d(0, 0, 0);\n  transition: transform 0.3s ease-in-out; }\n\n.slideRight__visible {\n  display: block;\n  transform: translate3d(0); }\n\n.slideRight__beforeLeave {\n  display: block;\n  transform: translate3d(0, 0, 0);\n  transition: transform 0.3s ease-in-out; }\n\n.slideRight__leaving {\n  display: block;\n  transform: translate3d(100%, 0, 0);\n  transition: transform 0.3s ease-in-out; }\n\n.slideRight__afterLeave {\n  display: none; }\n\n.explode__offscreen {\n  display: none; }\n\n.explode__beforeEnter {\n  display: block;\n  transform: scale(0.01);\n  transition: transform 0.3s ease-in-out; }\n\n.explode__entering {\n  display: block;\n  transform: scale(1);\n  transition: transform 0.3s ease-in-out; }\n\n.explode__visible {\n  display: block;\n  transform: scale(1); }\n\n.explode__beforeLeave {\n  display: block;\n  transform: scale(1);\n  opacity: 1;\n  transition: all 0.3s ease-in-out; }\n\n.explode__leaving {\n  display: block;\n  opacity: 0.5;\n  transform: scale(2);\n  transition: all 0.3s ease-in-out; }\n\n.explode__afterLeave {\n  display: none; }\n\n.implode__offscreen {\n  display: none; }\n\n.implode__beforeEnter {\n  display: block;\n  opacity: 0.2;\n  transform: scale(2);\n  transition: all 0.3s ease-in-out; }\n\n.implode__entering {\n  display: block;\n  opacity: 1;\n  transform: scale(1);\n  transition: all 0.3s ease-in-out; }\n\n.implode__visible {\n  display: block;\n  opacity: 1;\n  transform: scale(1); }\n\n.implode__beforeLeave {\n  display: block;\n  transform: scale(1);\n  transition: transform 0.3s ease-in-out; }\n\n.implode__leaving {\n  display: block;\n  transform: scale(0.01);\n  transition: transform 0.3s ease-in-out; }\n\n.implode__afterLeave {\n  display: none; }\n", ""]);
